...
class GradCAM:
    ...
    def generate_cam(self, input_tensor, target_class=None):
        ...
        if gradients is None or activations is None:
            raise ValueError(
                "Gradienty lub aktywacje są None - sprawdź czy hooki działają poprawnie"
            )
...
def verify_gradcam_explanation(
    model, sample, gradcam_map, device, reverse_label_mapping, percentile=80
):
    """
