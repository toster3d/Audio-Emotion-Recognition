        ...
        for feature_type in self.feature_types:
            ...
            if feature_type not in self.feature_data:
                try:
                    ...
                    raise RuntimeError(
                        f"Błąd ładowania pliku cech {self.feature_files[feature_type]}: {e}"
                    ) from e
